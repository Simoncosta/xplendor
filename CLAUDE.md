...
>
> Última actualização: 2026-06-17 · Versão 1.14.2
...
| `cars` | Viaturas por empresa | `price_gross`, `power_hp`, `segment`, `seats`, `status`, `car_category_id`, `engine_brand` (M2.2, nullable — marca do motor, só motorhome/caravan; distinto de `vehicle_attributes.chassis_structure.chassis_type` que é tipo de chassis) |
