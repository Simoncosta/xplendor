...
>
> Última actualização: 2026-06-16 · Versão 1.14.0
...
- **Relatório B — vendas** (separado do Relatório A; em paralelo / posterior à Camada 2). Atribuição de leads, ROI por canal/campanha, ciclo médio por modelo. Tabelas de base existem (`car_sales`, `car_sale_attributions`, `car_sales_learning`, `campaign_car_metrics_daily`). Sem urgência definida — entra depois de a Camada 2 da priorização estabilizar e produzir dados de tráfego.
