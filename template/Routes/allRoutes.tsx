...
import BasicSignIn from '../pages/AuthenticationInner/Login/BasicSignIn'; // todo:delete
import CoverSignIn from '../pages/AuthenticationInner/Login/CoverSignIn'; // todo:delete
...
const publicRoutes = [
  ...
  { path: "/auth-signin-cover", component: <SignIn /> },
