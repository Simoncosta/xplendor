        ...
        <Section id="pacotes" variant="alt">
            <div className="text-center mb-4">
                ...
                <p className="lp-section-sub mx-auto mt-2">
                    ...
                    {withVat
                        ? 'IVA (23%) incluído nos valores indicados.'
                        : 'Valores sem IVA à taxa legal em vigor (23%).'}
                </p>
            </div>

            <div className="d-flex justify-content-center mb-5">
                <div className="lp-pricing-toggle" role="group" aria-label="Mostrar preços com ou sem IVA">
                    <button
                        type="button"
                        className={`lp-pricing-toggle__btn${!withVat ? ' active' : ''}`}
