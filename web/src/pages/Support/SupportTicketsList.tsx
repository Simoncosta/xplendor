...
const TYPES: SupportTicketType[] = ["idea", "improvement", "bug", "suggestion"];
                                    ...
                                    return (
                                        <Link key={t.id} to={`/support/${t.id}`} className="d-flex align-items-center gap-3 border rounded p-3 text-reset text-decoration-none">
                                            <span className="avatar-xs flex-shrink-0">
                                                <span className="avatar-title bg-light text-primary rounded fs-18"><i className={tm.icon} /></span>
                                            </span>
                                            <div className="flex-grow-1 min-w-0">
                                                <div className="fw-medium text-truncate">{t.title}</div>
                                                <small className="text-muted">{tm.label}{t.messages_count ? ` · ${t.messages_count} mensagem(ns)` : ""}</small>
                                            </div>
