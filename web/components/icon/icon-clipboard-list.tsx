...
const IconClipboardList: FC<IconClipboardListProps> = ({ className }) => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            ...
            <path d="M10.5 14L17 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M7 14H7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M7 10.5H7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M7 17.5H7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M10.5 10.5H17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M10.5 17.5H17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
