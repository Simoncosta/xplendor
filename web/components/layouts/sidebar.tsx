...
import IconCity from '../icon/icon-city';
import IconHospital from '../icon/icon-hospital';
                    ...
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            {theme === 'light' ? (
                                ...
                                <img className="ml-[5px] w-8 flex-none" src="/assets/images/logo-dark.svg" alt="logo" />
                            )}
                            <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">PLENDOR</span>
                        </Link>
                            ...
                            <li className="menu nav-item">
                                <Link href="/users" className="nav-link group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('users.title')}</span>
                                    </div>
                                </Link>
                            </li>
                            <li className="menu nav-item">
                                <Link href="/companies" className="nav-link group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('companies.title')}</span>
                                    </div>
                                </Link>
                            </li>
